      ...
      type mgt_header         
          ...
          character (len=18) :: phua =      "          phuplant"  
          character (len=13) :: sw =        "   soil_water" 
          character (len=18) :: bio =       "       plant_bioms"
          ...
          character (len=18) :: var2 =      "              var2"
          character (len=16) :: var3 =      "               var3"
          character (len=14) :: var4 =      "             var4"
