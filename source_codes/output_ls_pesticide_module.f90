      ...
      type output_pestbal_header
        ...
        character (len=12) :: plant =       "  plant_kg/ha "       
        character (len=12) :: soil =        "    soil_kg/ha"
        character (len=12) :: sed =         "    sed_kg/ha "        
        character (len=12) :: surq =        "   surq_kg/ha "      
        character (len=12) :: latq =        "   latq_kg/ha " 
        character (len=12) :: tileq =       "  tileq_kg/ha "
        character (len=12) :: perc =        "   perc_kg/ha "  
        character (len=16) :: apply_s =     "   apply_s_kg/ha"
        character (len=13) :: apply_f =     " apply_f_kg/ha "
        character (len=13) :: decay_s =     " decay_s_kg/ha"
        character (len=13) :: decay_f =     " decay_f_kg/ha"
        character (len=13) :: wash =        " wash_kg/ha   "
