...
!! routines for plant module
      ...
      include 'pl_nfix.f90'
      include 'pl_tstr.f90'
      include 'pl_anfert.f90'
      include 'pl_irrigate.f90'
      include 'pl_fert.f90'
      include 'pl_burnop.f90'
      include 'pl_confert.f90'
      include 'pl_conapply.f90'
      include 'pl_graze.f90'
      include 'pl_apply.f90'
      include 'pl_rootfr.f90'
