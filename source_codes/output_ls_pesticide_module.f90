      ...
      type output_pestbal_header
        ...
        character (len=16) :: apply_s =     "   apply_s_kg/h"
        character (len=13) :: apply_f =     " apply_f_kg/h "
        character (len=13) :: decay_s =     " decay_s_kg/h"
        character (len=13) :: decay_f =     " decay_f_kg/h"
        character (len=13) :: wash =        " wash_kg/h   "
