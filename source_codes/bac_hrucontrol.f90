...
!!    ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
      ...
      do ib = 1, mbac
        ...
        if (pcom(j)%path(ib) < 1.e-6) pcom(j)%path(ib) = 0.0

        !! bacteria washoff, regrowth and dieoff in the soil layer and on the plant
        call bac_ls_process (ibtyp, pcom(j)%path(ib),                  &
        ...
        if (qday > 0.) then
        call bac_ls_runoff (ibtyp, pcom(j)%path(ib),                   &  
             soil(j)%ly(1)%bacsol(ib), soil(j)%ly(1)%bacsor(ib),             &
        ...
        call bac_ls_swrouting (ibtyp, pcom(j)%path(ib),                &
