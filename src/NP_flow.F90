    ...
    real, intent(in) :: C_AtoB      !                |C_AtoB        C flow from pool A to pool B (kg N or P ha-1 day-1)
    real, intent(in) :: CO2fromA    !                |CO2fromA       CO2 emission during the decomposition of pool A (kg C ha-1 day-1)
