...
!!!  SWAT-DEG CHANNEL
      if (sp_ob%chandeg > 0) then
        if (pco%sd_chan%d == "y") then
          ...
          write (2500,*) ch_watbod_hdr, hyd_stor_hdr, hyd_in_hdr, hyd_out_hdr
          write (2500,*) ch_watbod_hdr_units, hyd_hdr_units1, hyd_hdr_units1, hyd_hdr_units1
          write (9000,*) "SWAT-DEG CHANNEL          channel_sd_day.txt"
          if (pco%csvout == "y") then
            open (2504,file="channel_sd_day.csv",recl = 1500)
            write (2504,*) bsn%name, prog
            write (2504,'(*(G0.3,:,","))') ch_watbod_hdr, hyd_stor_hdr, hyd_in_hdr, hyd_out_hdr
            write (2504,'(*(G0.3,:,","))') ch_watbod_hdr_units, hyd_hdr_units1, hyd_hdr_units1, hyd_hdr_units1
        ...
        if (sp_ob%chandeg > 0) then
          ...
          write (2501,*) ch_watbod_hdr, hyd_stor_hdr, hyd_in_hdr, hyd_out_hdr
          write (2501,*) ch_watbod_hdr_units, hyd_hdr_units1, hyd_hdr_units1, hyd_hdr_units1
          write (9000,*) "SWAT-DEG CHANNEL          channel_sd_mon.txt"
          if (pco%csvout == "y") then
            open (2505,file="channel_mon_sd.csv",recl = 1500)
            write (2505,*) bsn%name, prog
            write (2505,'(*(G0.3,:,","))') ch_watbod_hdr, hyd_stor_hdr, hyd_in_hdr, hyd_out_hdr  
            write (2505,'(*(G0.3,:,","))') ch_watbod_hdr_units, hyd_hdr_units1, hyd_hdr_units1, hyd_hdr_units1
      ...
      if (sp_ob%chandeg > 0) then
        if (pco%sd_chan%y == "y") then
          ...
          write (2502,*) ch_watbod_hdr, hyd_stor_hdr, hyd_in_hdr, hyd_out_hdr
          write (2502,*) ch_watbod_hdr_units, hyd_hdr_units1, hyd_hdr_units1, hyd_hdr_units1
          write (9000,*) "SWAT-DEG CHANNEL          channel_sd_yr.txt"
          if (pco%csvout == "y") then
            open (2506,file="channel_sd_yr.csv",recl = 1500)
            write (2506,*) bsn%name, prog
            write (2506,'(*(G0.3,:,","))') ch_watbod_hdr, hyd_stor_hdr, hyd_in_hdr, hyd_out_hdr
            write (2506,'(*(G0.3,:,","))') ch_watbod_hdr_units, hyd_hdr_units1, hyd_hdr_units1, hyd_hdr_units1
        ...
        if (sp_ob%chandeg > 0) then
          ...
          write (2503,*) ch_watbod_hdr, hyd_stor_hdr, hyd_in_hdr, hyd_out_hdr
          write (2503,*) ch_watbod_hdr_units, hyd_hdr_units1, hyd_hdr_units1, hyd_hdr_units1
          write (9000,*) "SWAT-DEG CHANNEL          channel_sd_aa.txt"
          if (pco%csvout == "y") then
            open (2507,file="channel_sd_aa.csv",recl = 1500)
            write (2507,*) bsn%name, prog
            write (2507,'(*(G0.3,:,","))') ch_watbod_hdr, hyd_stor_hdr, hyd_in_hdr, hyd_out_hdr   
            write (2507,'(*(G0.3,:,","))') ch_watbod_hdr_units, hyd_hdr_units1, hyd_hdr_units1, hyd_hdr_units1
      ...
      if (sp_ob%chandeg > 0) then
        if (pco%sd_chan%d == "y") then
          ...
          if (pco%csvout == "y") then
            ...
            write (9000,*) "SWAT-DEG CHANNEL MORPH    channel_sd_day.csv"
          end if
        endif
      endif
