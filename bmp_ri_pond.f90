...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      real, dimension(3,0:time%step), intent(in out) :: riflw,rised
      real, dimension(0:time%step) :: inflw,insed,outflw,outsed
      ...
      do ii=1,time%step
         ...
         qseep = ksat * tsa / 1000./ 60. * time%dtm !m^3
         ...
         if (sedconc>12.) then ! assume 12mg/l as equilibrium concentration, , Huber et al. 2006
           ...
           td = 1. / time%step !detention time, day
