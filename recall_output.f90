...
!!                 'day'   = daily
        ...
        if (time%yrc >= pco%yr_start .and. time%day >= pco%jd_start .and. time%yrc <= pco%yr_end  &
          ...
          if (pco%recall%d == 'y') then
            ...
            if (pco%csvout == 'y') then
              write (4504,'(*(G0.3,:","))') time%day, time%yrc, irec, rec_d(irec)
            end if
          end if
        end if
        ...
        if (time%end_mo == 1) then
          ...
          if (pco%recall%m == 'y') then
            ...
            if (pco%csvout == 'y') then
              write (4505,'(*(G0.3,:","))') time%mo, time%yrc, irec, rec_m(irec)
            endif
          end if
          rec_m(irec) = hz
        end if
        ...
        if (time%end_yr == 1) then
          ...
          if (pco%recall%y == 'y') then
            ...
            if (pco%csvout == 'y') then
              write (4506,'(*(G0.3,:","))') '     0', time%yrc, irec, rec_y(irec) 
            end if
          end if
      ...
      !! average annual print - RECALL
          ...
          rec_a(irec) = rec_a(irec) / time%yrs_prt
            write (4503,102) '     0', time%yrs, irec, rec_a(irec)
            if (pco%csvout == 'y') then 
