       ...
       if (pco%day_print == "y" .and. pco%int_day_cur == pco%int_day) then
        if (pco%sd_chan_bsn%d == "y") then
          ...
          if (pco%csvout == "y") then
            write (2124,'(*(G0.3,:","))') time%day, time%mo, time%day_mo, time%yrc, "       1", "     1", bsn%name,&
                    bchsd_d
          end if 
        end if 
      end if
...
!!!!! monthly print
      if (time%end_mo == 1) then
        ...
        if (pco%sd_chan_bsn%m == "y") then
          ...
          if (pco%csvout == "y") then
            write (2125,'(*(G0.3,:","))') time%day, time%mo, time%day_mo, time%yrc, "       1", "     1", bsn%name,&
                    bchsd_m
          end if
        end if
        bchsd_m = chsdz
...
!!!!! yearly print
      if (time%end_yr == 1) then
        ...
        if (pco%sd_chan_bsn%y == "y") then 
          ...
          if (pco%csvout == "y") then
            write (2126,'(*(G0.3,:","))') time%day, time%mo, time%day_mo, time%yrc, "       1", "     1", bsn%name,&
                    bchsd_y
          end if
        end if
...
!!!!! average annual print
      if (time%end_sim == 1 .and. pco%sd_chan_bsn%a == "y") then
        ...
        if (pco%csvout == "y") then
          write (2127,'(*(G0.3,:","))') time%day, time%mo, time%day_mo, time%yrc, "       1", "     1", bsn%name,&
                  bchsd_a
        end if
      end if
