      ...
      sedi = sedyld(ihru) * frac_in
      sani = sanyld(ihru) * frac_in
      sili = silyld(ihru) * frac_in
	  clai = clayld(ihru) * frac_in 
	  sagi = sagyld(ihru) * frac_in
	  lagi = lagyld(ihru) * frac_in
	  grai = grayld(ihru) * frac_in
