...
test_datos = {
    ...
    "Usa_Basin_model": ["luse", "hru_land_use_mgt"]
}
...
datos = {
    ...
    'sd_chd': np.array([0.5, 0.5, 0.5, 0.5, 0.5, 0.5]),        #m          |channel depth
    'sd_chs': np.array([0.01 , 0.005, 0.005, 0.005, 0.005, 0.005]),        #m/m        |channel slope
    ...
    "hru_land_use_mgt": np.array([1, 1, 2, 2, 3, 3, 12, 12, 11, 11,  6,  7,  8, 10,  1,  9, 14, 13,  1,  2,  3, 11, 10,
  7, 12,  8,  6,  1,  9, 13,  1, 12,  6, 11,  8, 10,  7,  2,  3,  9, 13,  1, 14,  1, 12,  2,  9,
  6,  8,  7, 11,  3, 10,  1, 13,  1, 12,  2,  8, 10, 11,  6,  9,  3,  7,  1, 13,  1,  2, 11,  3,
 12,  7,  9, 10,  8,  6,  1, 13,  2, 11,  6,  8,  9,  3,  7, 12, 10,  1,  1, 13,  1, 3, 2, 11, 12,  8,  7, 10,  6,  1,
 9, 13, 14, 12, 6, 8, 10, 1, 3, 11, 7, 2, 1, 9, 11, 1, 7, 12, 10, 8, 9, 3, 2, 6, 13, 11, 12, 7, 1, 8, 2, 3, 10, 6, 9]),
    ...
    "luse": np.array([2, 1, 2, 2, 3, 3, 12, 12, 11, 11,  6,  7,  8, 10,  1,  9, 14, 13,  1,  2,  3, 11, 10,
  7, 12,  8,  6,  1,  9, 13,  1, 12,  6, 2,  8, 10,  7,  2,  4,  9, 13,  1, 14,  1, 12,  2,  9,
  6,  8,  7, 11,  3, 10,  1, 13,  1, 12,  2,  8, 10, 11,  6,  10,  3,  7,  1, 13,  1,  2, 11,  3,
  12,  7,  9, 10,  8,  6,  1, 13,  2, 11,  6,  8,  9,  3,  7, 12, 10,  1,  1, 13,  1, 3, 2, 11, 12,  8,  7, 10,  6,  1,
  9, 13, 14, 12, 6, 8, 10, 1, 3, 11, 7, 2, 1, 9, 11, 1, 7, 12, 10, 8, 9, 3, 2, 6, 13, 11, 12, 7, 1, 8, 2, 3, 10, 6, 9]),
